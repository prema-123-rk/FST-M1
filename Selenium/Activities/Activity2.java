...
public class Activity2 {
    ...
    @Test
    public void testSendInputToLoginForm() {
        ...
        WebElement usernameField = driver.findElement(By.cssSelector("input[id='username'], input[name='username']"));
        usernameField.sendKeys("admin");

        // VERIFY: same caveat as above, but for the password field
        WebElement passwordField = driver.findElement(By.cssSelector("input[id='password'], input[name='password']"));
